...
class Sidebar:
    ...
    def get_validated(self):
        return """<tr class=sidelight><td class=sidelight align="center">
        <a class="sidelight" href="http://validator.w3.org/check/referer"><img class="sidelight" border="0"
        src="http://www.w3.org/Icons/valid-html401"
        alt="Valid HTML 4.01!" height="31" width="88"%s</a>
        </td></tr>
        """ % (self.empty_tag_end)

    def __start_table(self):
        print '<!-- start of sidebar table -->'
        print '<table summary="Sidebar table" class="side" width="100%" border="0" cellspacing="0" cellpadding="3">'
        ...
        for item in self.links:
            if type(item) == StringType:
                ...
                if done_one:
                    ...
                    print '<tr><td class="sidelight">&nbsp;'
                else:
                    done_one = 1
                print '<tr class=side><td class="side"><b class=side>'
                print item
                print '</b></td></tr>'
            else:
                if len(item) == 3:
                ...
                if url is None:
                    ...
                    s = '<a  class="sidelight" href="%s">%s</a>' % (url, text)
                print '<tr class=sidelight><td  class="sidelight">'
                print '%s%s' % (s, extra)
                print '</td></tr>'
