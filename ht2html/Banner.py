...
class Banner:
    ...
    def __start_table(self):
        ...
        print '<table summary="Site links table" width="100%" border="0" cellspacing="0" cellpadding="1" >'
        print '<tr>'
    ...
    def __do_table(self):
        ...
        for item in self.__links:
            ...
            if not url:
                ...
                s = '<a class="banner" href="%s">%s</a>%s' % (url, text, extra)
            if col >= self.__cols:
                # break the row
                print '</tr><tr>'
                col = 0
            print '    <td class="banner">'
            print s
            print '    </td>'
            col = col + 1
        # fill rest of row with non-breaking spaces.
        while col and col < self.__cols:
            print '<td class="banner">&nbsp;&nbsp;</td>'
            col = col + 1
