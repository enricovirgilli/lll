...
#sitelinks = [('index.html','Home'),
#     ('code/index.html','Software'),
#     ('links/index.html', 'Links'),
#     ('http://www.fe.infn.it/astro/','Unife'),
#     ('calcetto/index.html', 'Calcetto'),
#     ('foto/index.html','Foto'),
#     ('thanks.html', 'Ringraziamenti'),
#     ('trionfo/index.html', 'Trionfo!'),
#     ]
...
class MyGenerator(Skeleton, Sidebar, Banner):
    AUTHOR = 'darkmoon'
