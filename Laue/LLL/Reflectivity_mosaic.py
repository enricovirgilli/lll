...
mosaicity = 25. #in arcsec
eta_in_arcsec = mosaicity/2.35
eta = eta_in_arcsec * (math.pi/180.) * (1/3600.) #in radiance
...
best_try = EA_bendring_at_keVs(self, xtal_in_ring=1., NUM_OF_SIGMA=4)
